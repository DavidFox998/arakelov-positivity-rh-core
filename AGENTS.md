# AGENTS.md — arakelov-positivity-rh-core

## Role: RH-CLUSTER / POSITIVITY-CORE

**Cluster:** Riemann Hypothesis

**Core claim:** Arakelov positivity at the core — height inequalities that force ζ zeros onto the critical line
...
THIS     → arakelov-positivity-rh-core
```
...
Look for `ArakelovRH.lean` or files in `ArakelovRH/`.
